...
export default function EngineTransmission({ vehicle }: EngineTransmissionProps) {
      ...
      <div className="flex flex-col items-center h-full">
        <div className="flex items-center justify-between w-full px-2">
          ...
          <div className="flex flex-col items-center gap-2 w-16">
            ...
            <div className="mt-4 flex flex-col items-center">
              ...
              <div className="text-[9px] font-bold text-gray-400 uppercase">FUEL/HR</div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-2 w-16">
            ...
            <div className="mt-4 flex flex-col items-center">
              ...
              <span className="text-[9px] font-bold text-gray-400 uppercase">WATER</span>
            </div>
            <div className="mt-4 flex flex-col items-center">
              <span className="text-sm font-bold text-gray-600 tabular-nums">
                {getVal(vehicle?.motor?.fillUnits?.def?.usage)}
              </span>
              <span className="text-[9px] font-bold text-gray-400 uppercase">DEF/HR</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2 w-full mt-4 text-center border-t border-gray-100 pt-2">
          <div className="flex flex-row gap-2">
            ...
            />
            <StatusIconButton icon={<Power size={20} />} active={isTurnedOn} color="green" />
            <StatusIconButton
