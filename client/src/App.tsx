...
function FendtPanel({
  ...
  return (
    <div className="bg-fendt-panel border border-gray-300 rounded shadow-sm flex flex-col overflow-hidden">
...
function StatusIconButton({
  ...
  return <div className={`${baseClasses} ${activeClasses}`}>{icon}</div>;
}
